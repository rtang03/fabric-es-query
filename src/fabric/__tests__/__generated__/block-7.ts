...
export const block7: TBlock = {
  header: {
    number: 7,
    previous_hash: Buffer.from([
      43, 123, 208, 136, 24, 232, 73, 14, 215, 152, 150, 230, 90, 182, 96, 186, 35, 71, 47, 23, 83,
      143, 104, 140, 18, 9, 217, 203, 103, 149, 246, 193,
    ]),

    data_hash: Buffer.from([
      112, 254, 106, 41, 244, 193, 154, 84, 174, 59, 194, 35, 55, 31, 18, 172, 27, 104, 93, 20, 250,
      114, 111, 229, 62, 25, 94, 87, 194, 31, 81, 97,
    ]),
  },
  data: {
    data: [
      {
        signature: Buffer.from([
          48, 67, 2, 32, 52, 126, 10, 32, 178, 199, 163, 117, 201, 133, 227, 29, 33, 237, 85, 72, 3,
          75, 160, 119, 190, 226, 98, 149, 42, 145, 134, 150, 159, 173, 242, 179, 2, 31, 78, 112,
          174, 195, 102, 2, 179, 125, 167, 143, 14, 184, 34, 86, 107, 137, 81, 221, 34, 48, 229, 6,
          220, 190, 172, 162, 179, 116, 208, 199, 80,
        ]),
        ...
        payload: {
          header: {
            channel_header: {
              type: 3,
              version: 0,
              timestamp: '2021-12-26T15:30:37.794Z',
              channel_id: 'loanapp',
              tx_id: '46d0466fe4d21f380eecbe7525303faad5568347512b12b654bc84f6cf95598d',
              epoch: 0,
            ...
            signature_header: {
              ...
              nonce: Buffer.from([
                61, 67, 38, 246, 182, 212, 143, 36, 125, 63, 221, 95, 33, 198, 39, 157, 146, 196,
                155, 143, 164, 44, 229, 37,
              ]),
            },
          },
          data: {
            actions: [
              {
                header: {
                  ...
                  nonce: Buffer.from([
                    61, 67, 38, 246, 182, 212, 143, 36, 125, 63, 221, 95, 33, 198, 39, 157, 146,
                    196, 155, 143, 164, 44, 229, 37,
                  ]),
                },
                payload: {
                  ...
                  action: {
                    proposal_response_payload: {
                      proposal_hash: Buffer.from([
                        216, 218, 185, 157, 167, 116, 253, 76, 4, 212, 186, 16, 114, 195, 23, 214,
                        2, 190, 202, 253, 50, 87, 186, 172, 144, 219, 191, 111, 215, 88, 247, 29,
                      ]),
                      ...
                      extension: {
                                ...
                                writes: [
                                  {
                                    ...
                                    value: Buffer.from([
                                      ...
                                      44, 34, 109, 115, 112, 73, 100, 34, 58, 34, 79, 114, 103, 49,
                        ...
                        events: {
                          ...
                          payload: Buffer.from([
                            ...
                            103, 49, 77, 83, 80, 34, 44, 34, 101, 118, 101, 110, 116, 115, 34, 58,
                        ...
                        response: {
                          ...
                          payload: Buffer.from([
                            ...
                            44, 52, 57, 44, 55, 55, 44, 56, 51, 44, 56, 48, 44, 51, 52, 44, 49, 50,
                    ...
                    endorsements: [
                      {
                        ...
                        signature: Buffer.from([
                          48, 68, 2, 32, 29, 197, 85, 240, 227, 175, 213, 226, 162, 36, 75, 120,
                          156, 175, 168, 107, 142, 103, 229, 65, 30, 81, 247, 172, 162, 194, 163,
                          255, 42, 235, 175, 100, 2, 32, 4, 74, 215, 193, 164, 3, 81, 158, 150, 22,
                          126, 44, 193, 79, 215, 108, 211, 249, 169, 12, 232, 121, 249, 66, 192, 69,
                          219, 89, 189, 91, 7, 140,
                        ]),
                      },
                      {
                        ...
                        signature: Buffer.from([
                          48, 69, 2, 33, 0, 208, 174, 93, 91, 101, 118, 247, 249, 211, 226, 123, 81,
                          32, 87, 128, 207, 14, 170, 8, 194, 139, 11, 172, 225, 66, 116, 227, 161,
                          53, 95, 63, 91, 2, 32, 70, 244, 82, 224, 159, 129, 75, 34, 86, 227, 34,
                          120, 116, 169, 152, 39, 58, 98, 161, 56, 241, 248, 167, 160, 75, 174, 140,
                          6, 141, 35, 78, 111,
                        ]),
                      },
                    ],
  ...
  metadata: {
    metadata: [
      {
        value: Buffer.from([10, 2, 8, 2, 18, 13, 10, 11, 10, 5, 1, 2, 3, 4, 5, 16, 6, 24, 13]),
        ...
        signatures: [
          {
            signature_header: {
              ...
              nonce: Buffer.from([
                209, 217, 154, 89, 167, 46, 181, 188, 244, 211, 217, 158, 9, 18, 134, 97, 125, 239,
                114, 204, 16, 147, 171, 248,
              ]),
            },
            signature: Buffer.from([
              48, 68, 2, 32, 71, 190, 174, 49, 255, 49, 82, 163, 178, 67, 48, 157, 87, 130, 111, 99,
              98, 213, 157, 177, 170, 226, 128, 235, 17, 150, 221, 32, 232, 121, 186, 169, 2, 32, 7,
              31, 20, 45, 0, 97, 232, 29, 105, 26, 182, 254, 135, 125, 224, 35, 67, 222, 11, 179,
              50, 78, 177, 130, 233, 137, 132, 29, 50, 132, 144, 71,
            ]),
          },
        ],
      },
      ...
      {},
      Buffer.from([
        10, 32, 110, 40, 42, 94, 245, 167, 189, 27, 160, 148, 223, 78, 250, 57, 119, 237, 51, 48,
        64, 226, 253, 98, 219, 165, 121, 236, 32, 7, 130, 160, 62, 102,
      ]),
    ],
  },
};
